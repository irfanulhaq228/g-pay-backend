...
const merchantSchema = new mongoose.Schema({
    ...
    dailyMerchantLimit: { type: Number, required: false, default: 0 },
    remainingDailyMerchantLimit: { type: Number, required: false, default: 0 },
    lastLimitResetDate: { type: Date, required: false },
    ...
    remainingAccountLimit: { type: Number, required: false, default: 0 },
