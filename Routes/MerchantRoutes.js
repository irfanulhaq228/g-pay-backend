...
const { getAllData, createData, getDataById, updateData, deleteData, loginData, verifyData, webInfo, getDataByWebsite, checkMerchant } = require('../Controllers/MerchantController')
...
router.post('/check', checkMerchant)
